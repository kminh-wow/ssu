...
public class Test2 {
    public static void main(String[] args) {
        ...
        double result39 = mA.trace(mA);
        System.out.println("39. 대각합");
        System.out.println("원본 행렬:\n" + mA);
        System.out.println("기댓값: " + expectedAnswer39);
        System.out.println("대각합: " + result39);
        System.out.println(result39 == Double.parseDouble(expectedAnswer39.getValue()) ? "통과" : "실패");
        System.out.println("");
        ...
        boolean result40 = mA.isSquare(mA);
        ...
        boolean result41 = mA.isUpperTriangular(mA);
        ...
        boolean result42 = mA.isLowerTriangular(mA);
        ...
        boolean result43 = mA.isIdentity(mA);
        ...
        double result53 = mA.getDeterminant(mA);
