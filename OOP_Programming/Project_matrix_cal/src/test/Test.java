...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("결과: " + sA.compareTo(s3));
        System.out.println("");
        ...
        System.out.println(sA + " + " + sB + " = " + Tensors.add(sA, sB));
        System.out.println("");

        // 25. static 스칼라 곱셈
        System.out.println("25. static 스칼라 곱셈");
        System.out.println(sA + " * " + sB + " = " + Tensors.multiply(sA, sB));
        System.out.println("");

        // 26. static 벡터 덧셈
        System.out.println("26. static 벡터 덧셈");
        System.out.println(vA + " + " + vB + " = " + Tensors.add(vA, vB));
        System.out.println("");

        // 27. static 벡터 곱셈
        System.out.println("27. static 벡터 곱셈");
        System.out.println(vA + " * " + sA + " = " + Tensors.multiply(vA, sA));
        System.out.println("");
